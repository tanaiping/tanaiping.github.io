...
// 分享数据
var shareData = {
	url: "http://activity.peanut8.com/act/2020/nitori/detail.html",
	imgUrl: "http://activity.peanut8.com/act/2020/nitori/images/share.jpg",
	title: "NITORI 家具&家居 五一居家享好礼",
	text: "NITORI 家具&家居 五一居家新定义更多优惠等你来拿"
};
// 后台接口
var urlConfig = {
...
function login() {
	...
	nfyg.otherCommon.getDatanormal("post", urlConfig.login, "json", {
		...
		if (res.code == 1) {
			// 处理登录成功代码
			$.cookie('mobiles', res.data.userId, {
				expires: 7
			});
