...
var shareData = {
  "url": _baseUrl + "/act/2020/spring/html/index.html",
  "imgUrl": _baseUrl + "/act/2020/spring/images/share.png?",
  "title": "转春天",
  "text": "整杯喜茶,星巴克中杯，Q音&爱奇艺月卡任你转"
};
// 配置奖品
var prizeArr = ["QQ音乐绿钻月卡", "星巴克中杯", "谢谢参与", "爱奇艺黄金月卡", "喜茶-30元代金券", "再接再厉"]
// 活动规则
...
$(function () {
  ...
  $('.container').css('background', '#4ed6a4 url(' + config_img.bg + ') no-repeat top center / 100%')
