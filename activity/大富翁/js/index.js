$(function(){
    ...
    function getStep(){
      ...
      $.ajax({
          type: "post",
          url: basePath+'operateact/index',
          data:{"userId":tel},  //15814777383
          dataType: 'json',
          success: function(data) {
            console.log(data);
            redPacket = data.sVal;
            $(".ivita-num em").text(data.Invitation);
    ...
    function start_go(go_nums,endstep){
        ...
        setTimeout(function(){
            switch(step)
            {
            case 2:case 6:case 4:case 8: case 13:case 16:case 19:case 20: case 10:case 15:
                ...
                if(data.code==1){
                  ...
                  $(".input-box input").val("");
                   ...
                   $(".lottery-btn").removeClass('disabled');
                    ...
                    change_useup("当前机会已用完","成功邀请好友， 可再次获得掷骰子机会哦～",1);
    ...
    $(".get-btn").click(function(){
      ...
      if(isApp){
          ...
          if(!$(this).hasClass('disabled')){
              ...
              $.ajax({
                type: "post",
                url: basePath+'operateact/receivePrize',
  ...
  function share(){
    ...
    $(".black-formsbg,.day-useup,.task").hide();
    if(isApp) {
