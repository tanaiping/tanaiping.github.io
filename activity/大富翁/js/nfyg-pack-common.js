...
(function(global, factory) {
  ...
  NFYG.prototype = {
    ...
    peanutPay: function(
      ...
      if (Browser.ios) {
        return window.webkit.messageHandlers.peanutPay.postMessage({
          payType: payType,
          bussiCode: bussiCode,
          bussiDesc: bussiDesc,
          "goodsCode,": goodsCode,
        ...
        return window.news.openSharePanel(
          payType,
          bussiCode,
          bussiDesc,
          goodsCode,
  ...
  var otherCommon = {
    ...
    timeCountDown: function(name) {
      if (wait == 0) {
        ...
        wait--;
        setTimeout(function() {
          otherCommon.timeCountDown(name);
        }, 1000);
      }
    },
    //  获取数据
