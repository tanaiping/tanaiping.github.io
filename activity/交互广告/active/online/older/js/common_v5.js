var preUrl = "http://adnew.wifi8.com/";
var type =2;  //  -1代表没中奖  其他代表中奖序号(只针对娃娃机有用的变量)
...
function myawards(activeType){
	window.location.href = 'my_awards_v5.html?activeType='+activeType+"&appkey="+appkey+"&uid="+uid;
}