...
// 分享数据
var shareData = {
  url: baseUrl + "/act/2020/superFriday/share_wx.html",
  imgUrl: baseUrl + "/act/2020/superFriday/images/share.jpg",
  title: "超级星期五",
  text: "半价AirPods Pro等你来抢"
};
// 后台接口
var urlConfig = {
...
function openNfygApp(linkUrl) {
  ...
  // } else {
	  // alert("nfyg://detail?url=" + linkUrl)
	  // return false;
    window.location.href = "nfyg://detail?url=" + linkUrl//shareData.url
    setTimeout(() => {
      // 下载落地页
