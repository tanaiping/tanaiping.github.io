<template>
  <div class="content">
    <div class="flex-search">
        ...
        <el-select v-model="iswhite" placeholder="请选择是否白名单" class="mr10">
         ...
         <el-date-picker
               ...
               end-placeholder="订单结束日期" class="mr10">
             </el-date-picker>
          <el-date-picker
                v-model="date2"
                type="daterange"
  ...
  export default{
    ...
    methods:{
      ...
      getListData() {
        const _this = this
        const formData = {}
        _this.$axios.get(Charge.orderManager, formData)
          .then((res) => {
            console.log(res)
