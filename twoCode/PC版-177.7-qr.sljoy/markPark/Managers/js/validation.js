...
function isUrl(url){
	...
	var urlRegex = /^([hH][tT]{2}[pP]:\/\/|[hH][tT]{2}[pP][sS]:\/\/)(.)+$/;
 ...
 * @returns
 */
function isPublishTarget(string){
	var integerReg = /^[1-9]\d*[0]$/;
	return integerReg.test(string);
}
 ...
 * @returns Boolean
 */
function isDecimalsFloat(string) {
 ...
 * @returns Boolean
 */
function isTwoDecimalsFloat(string) {
 ...
 * @returns Boolean
 */
function isThreeDecimalsFloat(string) {
	var reg = /^(0|([1-9]\d*))(\.\d{0,3})?$/;
	return reg.test(string);
}
