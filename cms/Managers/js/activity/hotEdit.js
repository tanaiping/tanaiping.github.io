layui.use(['jquery','element','layer','form','laydate'], function(){
    ...
    var  goodsid = "",activityid = "",ifr_src = "",couponid = "";
    ...
    if(ifr_src.indexOf("editType")!= -1){ //编辑
        ...
        type = 1;
        initHotDetailInfo(goodsid,'/sys/goods/getGoodsDetail?goodsId=',0); //1代表商品 有规格属性
    ...
    function saveSaleChange(obj,goodsType,type){
    	...
    	goodsid==undefined?goodsid=couponid:goodsid;
