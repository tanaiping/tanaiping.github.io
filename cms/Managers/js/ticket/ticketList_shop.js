	        ...
	        success: function(data) {
	        	...
	        	if(data.resultCode==0){
	        		...
	        		if(type==1){
	        			...
	        			if(coupon_source==0){
	        				$("#iframe",parent.document.body).attr({"src":"ticket/applyTicket_third_detail.html?type_detail=1&rdm="+Math.random(),"couponId":couponId});
	        			}else{
	        				$("#iframe",parent.document.body).attr({"src":"ticket/applyTicket_self_detail.html?type_detail=1&rdm="+Math.random(),"couponId":couponId});
	        			}
	        		}
	        	}else if(data.resultCode==3){
	        		localStorage.removeItem('role');
